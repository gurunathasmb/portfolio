    ...
    >
      ...
      <div className="max-w-2xl text-center md:text-left mt-10 md:mt-0">
        ...
        <div className="flex justify-center md:justify-start gap-4">
          <button className="bg-[#3AFF00]/80 text-black font-semibold px-4 py-2 rounded-xl transition duration-300 hover:bg-gradient-to-r hover:from-green-400 hover:via-yellow-400 hover:to-red-400">
            Hire Me
          </button>
          <button className="bg-[#3AFF00]/80 text-black font-semibold px-4 py-2 rounded-xl transition duration-300 hover:bg-gradient-to-r hover:from-green-400 hover:via-yellow-400 hover:to-red-400">
            Download CV
      ...
      <div className="relative mt-10 md:mt-0 flex justify-center items-center w-72 h-72">
        {/* Glowing Rotating Dashed Circle */}
