...
export default function About() {
  return (
    <section id="about" className="py-16 bg-gradient-to-br from to">
  <h2 className="text-3xl font-bold mb-6 text-[#3AFF00] text-center" >
    About Me
  </h2>
  <div className="md:flex justify-between items-start gap-10">
    <div className="md:w-1/2 bg-[#B2FFB2]/10 p-6 rounded-xl shadow-lg border border-[#3AFF00]">
