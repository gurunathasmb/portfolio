...
const projects = [
  {
    ...
    lock: false,
    description: 'A real-time speech recognition system using Natural Language Processing (NLP) and audio signal processing to transcribe spoken words into text with high accuracy. Built with Python and integrated using Web APIs.',
  },
  {
    ...
    lock: false,
    description: 'A convolutional neural network (CNN)-based model trained on labeled fashion datasets to predict clothing styles and trends. Focused on computer vision, deep learning, and fashion analytics.',
  },
  {
    title: 'GUDBLOOD',
    img: 'gud.png',
    ...
    lock: false,
    description: 'A full-stack platform for connecting blood donors and recipients in emergency situations. Includes user authentication, donor filtering, and request status tracking with React, Node.js, and MongoDB.',
  },
  {
    ...
    lock: false,
    description: 'A backend API service for cow breed detection using OpenCV and image processing techniques. Supports breed classification from uploaded images and returns results via RESTful endpoints.',
  },
  {
    ...
    lock: false,
    description: 'Performs binary sentiment classification (positive/negative) on text reviews using machine learning models such as Logistic Regression and Naive Bayes. Includes data preprocessing and model evaluation.',
  },
  {
  ...
  },
  {
    ...
    lock: true,
    description: 'Creates AI-generated avatars that speak from a still image and text/audio input. Uses Wav2Lip and GANs to produce realistic lip-sync animations for human-like communication and video generation.',
  },
];
